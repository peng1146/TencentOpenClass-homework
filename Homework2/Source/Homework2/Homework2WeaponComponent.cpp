...
{
	// 可以进入开火，并且获取 Character 的名字
	// UE_LOG(LogTemplateProjectile, Log, TEXT("In fire"));
	/*if (Character)
	{
		UE_LOG(LogTemp, Log, TEXT("Character Name: %s"), *Character->GetName());
	}*/
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			...
			// World->SpawnActor<AHomework2Projectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			AHomework2Projectile* SpawnedProjectile = World->SpawnActor<AHomework2Projectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);

			// 将发射的角色传输给 AHomework2Projectil.cpp
			if (SpawnedProjectile)
			{
				SpawnedProjectile->SetFiringCharacter(Character);  // 设置发射者为当前角色
			}
